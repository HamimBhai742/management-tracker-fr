...
export default async function ProjectsPage() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Native iOS and Android app development for fitness tracking with social features and gamification.",
    ...
    },
    {
      ...
      description:
        "Comprehensive digital marketing campaign including SEO, social media, and content marketing.",
    ...
    },
    {
      ...
      description:
        "Implement AI-powered chatbot for customer support with natural language processing.",
    ...
    },
    {
      ...
      description:
        "Design and implement scalable cloud infrastructure with auto-scaling and monitoring.",
    ...
    },
    {
      ...
      description:
        "Comprehensive security audit and implementation of compliance measures for GDPR and SOC 2.",
    ...
    },
    {
      ...
      description:
        "RESTful API development with comprehensive documentation and testing suite.",
    ...
    },
    {
      ...
      description:
        "Modernize legacy monolithic application to microservices architecture.",
