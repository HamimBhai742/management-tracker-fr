      ...
      <div className="animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
        <label className="flex items-start gap-3 cursor-pointer group">
          <input
            ...
            onChange={handleChange}
            className="mt-1 w-4 h-4 rounded border-zinc-300 dark:border-zinc-700 text-blue-600 focus:ring-blue-500 focus:ring-2 transition-all"
          />
        ...
        {errors.agreeToTerms && (
          <p className="text-sm text-red-500 mt-2 animate-fade-in">{errors.agreeToTerms}</p>
        )}
      </div>
